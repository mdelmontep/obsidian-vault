...
## Estado (2026-08-15) — `main` en `ff1ce5d`; **12 issues cerrados**, CERO PRs mías abiertas
...
🧾 **Issues nuevos del 15-ago (9 vivos):** #1204 (un import sin usar pasa `eslint` **Y** `tsc`) · #1206 · #1211 · #1212 · #1215 · **#1216** (`ready-for-human`) · #1218 · #1219 · #1222 — todos con etiqueta comprobada. **#1221 se abrió y se CERRÓ el mismo día**: el guard de evals podía callarse (su escáner no conocía los literales de regex) y traía el gemelo que su propio test anunciaba sin cubrir. Y evidencia en **#1044** con una **opción D** que ese issue no tenía: hashear el fuente **sin comentarios**, que no exige exportar ningún `SYSTEM_PROMPT` (lo que hacía que su opción A se mordiera la cola).
