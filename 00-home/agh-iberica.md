...
## Estado (2026-08-15) — `main` en `4405c6e`; **7 issues cerrados en dos trenes**, tercera tanda en PR

🟢 **Dentro el 15-ago, en dos trenes con gate de la COMBINACIÓN detrás de cada uno** (`842a72a` → `fc9c134` → `4405c6e`): #1207/#1195 · #1209/#1192 · #1205/#1191 · #1208/#1200 · #1210/#1189 · #1213/#1201 · #1214/#1193. Último gate: `agente 3337/239/5f · dashboard 1223/0/0f · base 4405c6e` ✓. **Tercera tanda abierta y sin mergear:** #1217/#1182 · #1220/#1197 · la de #1186+#1185.
...
🧾 **Issues nuevos del 15-ago:** #1204 (un import sin usar pasa `eslint` **Y** `tsc`) · #1206 · #1211 · #1212 · #1215 · #1216 · #1218 · #1219 · **#1221** · #1222. Y evidencia en **#1044** con una **opción D** que ese issue no tenía: hashear el fuente **sin comentarios**, que no exige exportar ningún `SYSTEM_PROMPT` (lo que hacía que su opción A se mordiera la cola).
...
📋 **Cola libre (`ready-for-agent`, al 15-ago):** del lote del 14-ago quedan **#1188** (barrido de fixtures no discriminantes) y **#1186/#1185** (ya en PR). Nuevos del 15-ago: **#1204** (import sin usar invisible a `eslint` y a `tsc`; 9 casos, uno en `hitl-brain.ts` = zona de Borja) · **#1206** (todo hunk con veredicto `ARNÉS ROTO` queda sin medir) · **#1215** (`NO_MUTABLE` casa cualquier línea que acabe en `{`: 36 de 734 hunks) · **#1219** (un pool nuevo de `tone.ts` deja ciegos a TRES candados a la vez) · **#1221** (el guard de evals puede callarse) · **#1222** · #1211 · #1212 · #1218. `ready-for-human`: **#1216**. **Decisiones mías:** **#1196** (¿`formal` puede leer su plantilla de texto en voz? `cercano` lo tiene prohibido desde #202) · #1167 · #1129 · **#1180 ya decidida (NO entra), no re-litigar**.
