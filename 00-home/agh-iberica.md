...
- ✅ **#952 CERRADO** — el digest entregó (10-ago). ✅ **#988 CERRADA por evidencia** (7-ago): el teléfono se entiende dígito a dígito, así que el `join(" - ")` preparado no hace falta.
- ✅ **Prod verificada.** El SSH SÍ abre (5251); lo que falla a ratos es el clasificador de permisos, no la red. **#953 cerrado por efecto**: los 3 hilos pasaron de `error` a `delivered`.
- **Vivas, ya sin PR asociada** (las de la tanda del 7-ago están mergeadas). De la auditoría del 7-ago: **#1031** (el patrón: dashboard client-scoped) · **#1033** (pantalla «Lo mío», espera a #1000) · **#1030** (cancelar hablando; la anáfora en #1038, falta la referencia por cuerpo — cuesta evals) · **#1032** (`addCandidate`: se escribe, nadie lo lee, no se puede quitar) · **#1026** (`llm-smoke` no corre desde que existe) · #1019 · #1020 · #1036 · #1037. **Del 10-ago:** **#1095** (responder al digest no tiene NI UNA eval, y su disparador es un prefijo de texto que nadie asevera) · **#1086** (la cifra de coste en 18 líneas y dos monedas) · **#1083** (`mutate:diff` no mide lo multilínea — 3 casos en un día) · **#1044** opción A · **#1072**.
