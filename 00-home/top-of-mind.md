...
- **TuFacturaIA — Slack LIVE en prod ✅ (#558+#564)** — `/factura` operativo (resumen/cobros verificados con datos reales). Pendiente solo **smoke de escritura** (`cobrada`→vincular→reintentar) + comandos #007b en vivo. Opcional futuro: Events URL para OCR (#005) + Manage Distribution multi-cliente. [[facturaia]]
