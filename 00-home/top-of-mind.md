...
- **TuFacturaIA — Slack #007 (PR #558) code-complete** — bot slash commands `/factura` (lectura+escritura, autoría real `agent:slack`). Bloqueado merge por CI billing; pendiente HITL (db push 406-411 + alta app Slack + `SLACK_ENABLED`). [[facturaia]]
