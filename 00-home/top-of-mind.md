...
- **FacturaIA Centro Fiscal IA — pendientes externos pre-beta** — MVP dev cerrado 2026-05-22 con audit+fix 7 olas (5 migs SQL 146/147/148/149/150, ~55 archivos TS, 136 tests pass, 4 docs arquitectura). Pendiente Manu operativo: (1) aplicar migs en Supabase prod; (2) contratar Backblaze B2 EU + bucket Object Lock Compliance 6a+1m; (3) FNMT TS@ vía CERES + cert X.509 a `/etc/secrets/`; (4) seguro RC Tech E&O 1M€ Hiscox/AXA (~600-1.200€/año); (5) abogado IT — Términos B2B/B2C + DPA art 28 + Runbook brecha (3-5k€); (6) ZDR OpenAI+Anthropic por ticket; (7) Stripe price IDs (14,90€ mensual / 149€ anual); (8) auditoría externa pre-beta REAF+abogado+pentest (10-15k€). Pricing 14,90€ validado vs mercado. Manual implementación + manual usuario §8.5 + manual admin §32 redactados.
