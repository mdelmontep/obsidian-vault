...
- **TuFacturaIA — consolidar ~6 duplicaciones idénticas** — diferidas del audit NOTES.md, ahora DESBLOQUEADAS tras completar la reorg split (14 ficheros en main 2026-07-05, ver archive). Detalle en `NOTES.md` (repo). [[facturaia]]
