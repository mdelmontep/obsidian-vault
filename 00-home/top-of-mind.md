...
- **TuFacturaIA — Integración Holded v1 (PR #787) — bloqueada SOLO en API key sandbox** — 9 slices bidireccional (contactos/productos/docs/gastos) + auditoría, 92 tests. Falta: key sandbox Holded → `node scripts/smoke-holded-api.mjs` → merge + migs 440-444 + crons Dokploy + `HOLDED_ENABLED`. Fase 2 (webhooks v2, migración v2, stock) decisión pendiente. [[facturaia-holded-integracion]] · [[facturaia]]
