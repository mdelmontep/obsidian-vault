...
- **TuFacturaIA — presupuestos propios en OCR (en curso, sin commitear)** — backend+endpoint hechos; siguiente: prompt LLM + resolver colisión migración 421/422. [[facturaia]]
