...
- **TuFacturaIA — unificación UI: `<Button>` fuente única EN PROD (5 PRs, −476 nativos)** — siguiente: enlaces btn-*, dialectos `.adm-btn-*`, otros primitivos (Input/Select/Modal), vaciar globals.css. [[facturaia]]
...
- **TuFacturaIA — vista móvil 2ª ola: 5 PRs abiertos (15-jul, sin mergear)** — #907 glass+menú flotante+fondo · #910 PWA/SW/offline (envío push bloqueado VAPID + mig 462) · #911 Recordar cobro (parte 2 detalle pendiente) · #916 badges/focus-trap · #917 escaneo multipágina (manual pendiente). Falta: revisar/mergear, PR-C (gestos+scroll infinito) + auditoría perf en sesión aparte, smoke iOS/PWA. Ver [[facturaia-vista-movil-segunda-ola]]. [[facturaia]]
