...
- **TuFacturaIA — PR #607 open** — ingesta justificante routing (botón manual + auto por confianza + reglas por proveedor) + «Convertir en recurrente» desde lista; listo para review+merge. [[facturaia]]
