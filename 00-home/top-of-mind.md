...
- **TuFacturaIA — reempaquetado Fase 2B: residual** — #513 en main (split conciliación gating `conciliacion_ia`/`integracion_banco`, sidebar candado, MRR anual+add-ons mig 401) + price Starter 14€ Stripe/Dokploy ✅. Falta: smoke prod #513 + **QA visual + merge #515** (UsageProvider aviso 80%) + opcional trial `base-checkout`. Spec [[facturaia-reempaquetado-planes]] · [[stripe-price-id-en-env-vs-precio-bd-editable-derivan]]
