...
- **TuFacturaIA — reempaquetado planes Fase 2B** — Fase 1+2 en prod (tier **Plus 29€**, migs 398/399, PR #509). Falta: split conciliación (sub-flags `conciliacion_ia`/`integracion_banco`), sidebar candado, price Starter 14€ en Stripe (hoy cobra 19€), MRR admin, aviso 80% global. Spec [[facturaia-reempaquetado-planes]] · [[grandfathering-snapshot-antes-de-reempaquetar-planes]]
