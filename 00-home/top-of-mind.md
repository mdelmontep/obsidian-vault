...
- **FacturaIA Centro Fiscal IA — activación monetización pre-beta** — Backend en prod 2026-05-22 (commit `122dc96`, migs 146-150 aplicadas, crons fiscal-avisos+recalcular activos respondiendo 200). Pendiente operativo Manu: (1) decidir cuenta Stripe (agencia vs SL separada) + crear 4 productos modo Test (Starter 12€ / Pro 23€ / Enterprise 49€ / Fiscal addon 14,90€/mes + 149€/año) — runbook `docs/runbooks/stripe-tiers-completo-setup.md`; (2) crear cuenta Backblaze con `info@agentesia.madrid` + bucket Object Lock Compliance — runbook `backblaze-b2-fiscal-worm-setup.md`; (3) enviar email a `comercial.ceres@fnmt.es` (plantilla lista en runbook `fnmt-tsa-email-solicitud-convenio.md`, 5 huecos a rellenar); (4) seguro RC Tech E&O 1M€ Hiscox/AXA (~600-1.200€/año); (5) abogado IT Términos B2B/B2C + DPA + Runbook brecha (3-5k€); (6) ZDR OpenAI+Anthropic por ticket. Lo mínimo para trial sandbox: solo (1) + (2).
