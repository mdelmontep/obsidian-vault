...
- **FacturaIA — tests proformas + abonos rectificativos** — emisión funcional. Falta Vitest proformas + tests abonos verificando `factura_origen_id` + total negativo + referencia visible en PDF (cumplimiento fiscal: num+fecha factura origen)
