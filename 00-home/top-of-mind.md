...
- **TuFacturaIA — vista móvil 2ª ola: 5 PRs MERGEADOS a main (15-jul, #907/#910/#911/#916/#917 + fix #921)** — glass+fondo · PWA/SW/offline · Recordar cobro · badges/focus-trap · escaneo multipágina. Deploy auto. **Pendiente (5 puntos, siguiente sesión con agentes paralelos + /loop)**: aplicar mig `463_push_subscriptions` (`supabase db push`) · VAPID + envío push · manual escaneo + umbral blur · smokes prod (artifact antes/después) · PR-C (gestos+scroll infinito) + perf. Ver [[facturaia-vista-movil-segunda-ola]]. [[facturaia]]
