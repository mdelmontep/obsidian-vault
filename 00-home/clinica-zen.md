...
2. **Recordatorios (`PJBMjLLE0vNJjZH8`) — tres bugs CORREGIDOS el 28-jul, falta el 400 de Kommo**. Salieron de la única ejecución con error del histórico (9407, 28-jul 06:30, lead 32984916, "Julián" `+34617314938`, evento `ejidsbhd41q51j2mqdtu2f7gp8`):
   ...
   - ⬜ **Pendiente: por qué Kommo devuelve 400.** Sospecha = el lead no tiene chat de WhatsApp vinculado (entró por teléfono). Afecta igual al `bot_id 63814` de la reserva por voz — lo debe responder el smoke del hito 1. Backup pre-fix: `cz-recordatorios-pre-fix-20260728-1339.json`.
