...
- **`<input type="number">` no rechaza un importe ES con miles, lo descarta a trozos** — `1.234,56` queda en `1.23456` sin un solo aviso, porque `1.234` sí es número válido para el navegador. Emitió la factura A2026-0177 con base 1,23 € y la registró en VeriFactu. Y una auditoría anterior lo había descartado con "ya lo sanea el navegador": sanea **descartando**, no rechazando. Ver [[input-number-nativo-corrompe-importe-es]]
