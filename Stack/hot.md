...
- **`git worktree remove` con cambios sin commitear ya lo BLOQUEA un hook** (git-guard regla 6, 5 casos en su suite) — tres tracks de agentes perdidos el 7-ago. Sale de esta lista: su riesgo es máquina, no advertencia. Lo que sigue siendo tuyo es no inventar el mecanismo de una anomalía sin reproducirla. Ver [[dos-salidas-contradictorias-no-son-un-mecanismo-hasta-que-lo-reproduces]]
