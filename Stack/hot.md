...
- **`git add -N` + `git stash` no conviven** — el intent-to-add hace fallar push/pop a medias («Entry not uptodate»); `git reset` antes de stashear, o commitea y rebasa. Ver [[git-add-intent-to-add-rompe-stash]]
