...
- **Un test no vale hasta que le rompes el código y falla** — si sale SIN víctima, sospecha del **arnés** antes que del candado (3 de cada 4). Diez modos catalogados; los del 10-ago: aserción en **rango** que incluye el fallo, **universo vacío**, **informe ajeno que recorta**, el servidor **sirve el código viejo** (reinícialo) y **dos puertas** que se cubren entre sí. Ver [[verificar-que-un-test-tiene-dientes-con-una-mutacion]]
