...
- **Un `Artifact` solo lo republica la cuenta que lo publicó** — «could not verify... non-member reader» tras 2-3 reintentos idénticos no es un fallo transitorio: pregunta si se publicó alguna vez desde otra cuenta/sesión antes de seguir reintentando. Ver [[artifact-solo-lo-republica-la-cuenta-que-lo-publico]]
