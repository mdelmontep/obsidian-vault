...
- **2FA/teléfono solo para quien usa el canal, no gate global** — exigirlo a todo usuario con sesión atrapa invitados (coste + callejón). Ver [[2fa-telefono-solo-para-canal-que-lo-usa-no-gate-global]]
