...
- **Visual regression CI: usar `next build`/`start` (NO `next dev` — lazy-compile → timeout 100%), acotar trigger, baselines en contenedor jammy** [[regresion-visual-ci-acotar-trigger-y-baselines-en-contenedor]]
