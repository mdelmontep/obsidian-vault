...
Caso real TuFacturaIA: `convertir_presupuesto_a_factura` creada en mig 036 con `(uuid, uuid)`, recreada en migs 082/084/088/119 con `(uuid, uuid, text, uuid, uuid)`. La 2-args sobrevivió 6 migs hasta detectarse durante smoke mig 119. Riesgo: callers olvidados usando la firma vieja con lógica desactualizada.
