...
default Y **cualquier valor que el LLM inventara**: 65 de 73 leads en 14 días no avisaron a
nadie. Quedaban en el CRM, así que ningún error, ninguna ejecución roja.
