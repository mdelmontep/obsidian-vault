...
Si la tabla es nueva y aún no tiene la clave única definida, mejor no llegar a necesitar este guard: ver [[clave-compuesta-por-tenant-elimina-el-guard-de-upsert-cross-tenant]].
