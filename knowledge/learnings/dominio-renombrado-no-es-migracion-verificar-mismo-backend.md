...
3. ¿Coincide el prefijo API? FacturaIA cambió de `/v1/*` a `/api/v1/*` con el dominio nuevo — el cliente HTTP del portal añadía `/api/v1` igual, pero el endpoint viejo era distinto.
