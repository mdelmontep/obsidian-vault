...
Caso 2026-05-22: confirmé mig 131 `desvincular_asignacion` aplicada (signature `(p_asignacion_id, p_razon, p_user_id)`) en TuFacturaIA prod sin psql ni Studio. Útil cuando `supabase migration list` confunde por columnas vacías ([[supabase-cli-adoptar-tarde-en-proyecto-con-migrations-aplicadas-por-studio]]).
