...
- ⏳ Resto: **047 GATE auditoría seguridad (humano, antes de exponer)** → 049 rol∩scope fino → 050/051 tools lectura → 052 multi-org → 053 crear-borrador+deep-link → 054 DCR/discovery → 055 consent pulido → 056 rate-limit/idempotency tools → 057 provider mcp-public → 058 docs → 059 deploy (crear proyecto Dokploy mcp.tufacturaia.com + DNS). (060 Fase 2).
