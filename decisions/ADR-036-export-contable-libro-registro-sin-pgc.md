...
**Update 2026-07-03**: el gap "como A3" quedó cubierto con el formato electrónico normalizado AEAT (plantilla LSI v9.0, `formato=aeat`, PR #658) — importable en Pre303 y reconocido por A3/Sage sin mapeo. Los formatos propietarios nativos dejan de ser necesarios; lo único que A3 sigue haciendo y nosotros no son los asientos con subcuentas PGC (workstream 2 de [[facturaia-export-gestoria-v15]]).
