...
- [[ADR-058-el-303-se-niega-a-calcular-con-prorrata-en-vez-de-multiplicar]] — multiplicar la cuota por el porcentaje daría un 303 igual de incorrecto pero mucho más creíble: faltan la regularización por porcentaje definitivo (c43), la de bienes de inversión (c42) y la prorrata especial por sectores. Se bloquea y se exportan libros. PR #2113.
- [[ADR-059-la-cadencia-del-runner-vive-en-la-bd-no-en-el-cron]] — el cron de Dokploy es un latido cada 15 min y la política (intervalo, pausa, topes de gasto) vive en la BD con RLS y auditoría. Se descarta dar al portal un token de escritura sobre su propia infraestructura. agency-portal / Flota IA 037.
- [[ADR-060-la-autorizacion-del-subencargado-la-da-el-contrato-no-una-puerta-por-cliente]] — el Anexo III §8 del contrato de alta ya autoriza a los proveedores de IA, así que la puerta por cliente del art. 28.2 (default cerrado, doce clientes a null, cero encolados) se retira. agency-portal / Flota IA 032-B.
- [[ADR-079-una-reserva-de-doctoralia-mueve-todos-los-deals-abiertos-del-lead]] — una reserva mueve todos los deals abiertos del lead a «1º Visita Programada» con nota y vencimiento, y solo crea uno si no había; una cancelación vuelve a «Volver a contactar», no a Lost (Centro Elphis, 3-sep).
